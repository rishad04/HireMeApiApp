                                           ...
                                           <div class="form-row">
                                                ...
                                                <div class="form-input-wrapper">
                                                    <select name="type" id="type" class="form-input @error('type') input-error @enderror" required>
                                                        ...
                                                        <option value="full_time" {{ old('type', $data->type) == 'full_time' ? 'selected' : '' }}>Full Time</option>
                                                        <option value="part_time" {{ old('type', $data->type) == 'part_time' ? 'selected' : '' }}>Part Time</option>
                                                        <option value="contractual" {{ old('type', $data->type) == 'contractual' ? 'selected' : '' }}>Contractual</option>
                                                    </select>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-input-wrapper">
                                                        <textarea name="description" id="description" cols="30" rows="4">{{ old('description', $data->description) }}</textarea>
                                                    @error('description')
                                                    <div class="error-text">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-input-wrapper">
                                                        <textarea name="short_description" id="short_description" cols="30" rows="2">{{ old('short_description', $data->short_description) }}</textarea>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-input-wrapper">
                                                    <select
                                                        ...
                                                        <option value="{{ $company->id }}" {{ old('company', $data->company_id) == $company->id ? 'selected' : '' }}>
                                                            {{ $company->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
